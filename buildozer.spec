...
# (list) Permissions
android.permissions = INTERNET,WAKE_LOCK,RECEIVE_BOOT_COMPLETED,SCHEDULE_EXACT_ALARM,POST_NOTIFICATIONS,USE_EXACT_ALARM,VIBRATE,USE_FULL_SCREEN_INTENT,SYSTEM_ALERT_WINDOW
